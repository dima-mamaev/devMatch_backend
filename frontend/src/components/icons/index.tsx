...
export const StarIcon = ({ className = "w-3 h-3" }: IconProps) => (
...
export const ZapIcon = ({ className = "w-3 h-3" }: IconProps) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
...
export const EyeOffIcon = ({ className = "w-4 h-4" }: IconProps) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    fill="none"
...
export const BookmarkIcon = ({ className = "w-4 h-4" }: IconProps) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    fill="none"
...
export const VolumeMuteIcon = ({ className = "w-4 h-4" }: IconProps) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    fill="none"
